    ...
    for(let i=0; i<CDM_list.length; i++){
      if(i == int){
        ...
        if(data.정답타입 == 'A'){
          ...
          this.state.answertype = "A"
        }else if(data.정답타입 == 'B'){
          this.state.colortype = "warning"
          this.state.answertype = "B"
        }else if(data.정답타입 == 'C'){
          this.state.colortype = "danger"
          this.state.answertype = "C"
        }
          ...
          result.push(
            <Card style={{"text-align": "left"}}>
              ...
              <CardBody>
                ...
                <Button style={{"margin-right":"10px", "background-color":"#0040FF", "display":"none"}} color="primary" id={tg1 } >A</Button>
                <Button style={{"margin-right":"10px", "background-color":"#0040FF"}} color="primary" tgid = {tg1} rts={data.정답타입} onClick={(e) => this.oxbutton('A', type, e)} id={tg4 } >A</Button>
                <Button style={{"margin-right":"10px", "display":"none"}} color="warning" id={tg1} >B</Button>
                <Button style={{"margin-right":"10px"}} color="warning" tgid = {tg1}  rts={data.정답타입} onClick={(e) => this.oxbutton('B', type, e)} id={tg4} >B</Button>
                <Button style={{"margin-right":"10px", "display":"none"}} color="danger" id={tg1} >C</Button>
                <Button style={{"margin-right":"10px"}} color="danger" tgid = {tg1}  rts={data.정답타입} onClick={(e) => this.oxbutton('C', type, e)} id={tg4} >C</Button>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
              ...
              <h4 class="text-white2 mt-0"> ABC 중에 선택해주세요</h4>
              ...
              <a class="btn btn-light btn-xl" href="#quiz">코로나 ABC 시작</a>
            </div>
          </div>
        </div>
      </section>
